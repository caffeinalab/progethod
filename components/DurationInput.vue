<template>
  <div class="leading-none">
    <input
      ref="inputEl"
      v-model="inputString"
      class="text-ink focus:outline-none focus:border focus:border-accent bg-card font-normal box-border w-16 h-10 pl-3 text-sm border-stroke rounded-lg border shadow"
